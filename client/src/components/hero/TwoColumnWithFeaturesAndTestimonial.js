...
export default ({
  heading = "O que é Home Care e Seus Benefícios?",
  description = "O Home Care, é qualquer serviço de suporte (Profissional Médico ao Domicílio Assistência Medica Domiciliar) que permita que uma pessoa viva com qualidade de vida e segurança em sua casa.",
  ...
  primaryButtonText = "Principais Benefícios Dos Serviços",
  buttonRounded = true,
  features = ["Melhora da qualidade de vida", "Estabilidade da doença", "Redução de custos com saúde", "Redução de internações", "Redução do absenteísmo", "Aumento da produtividade"],
  testimonial = {
    quote: "O Grupo MMS oferece serviços de assistência médica em domicílio funciona oferecendo serviços de cuidados hospitalares na casa do paciente e motivação individual assim como organizacional, por sua vez os níveis motivacionais dos colaboradores numa organização traduzem-se no bom ou mau desempenho dos mesmos.",
    customerName: "Grupo MMS",
    customerCompany: "GMMS LDA."
  }
}) => {
  ...
  const navLinks = [
    <NavLinks key={1}>
      ...
      <NavLink ><Link to="/sobre-nos">Sobre Nós</Link></NavLink>
      
      <NavLink ><Link to="/nossos-servicos">Serviços</Link></NavLink>
      <NavLink ><Link to="/entre-em-contacto">Entre em Contacto</Link></NavLink>
    </NavLinks>
