  ...
  const defaultFeatures = [
    {
      ...
      description: "A assistência médica em domicílio funciona oferecendo serviços de cuidados hospitalares na casa do paciente, Cuidados Ambulatoriais: o paciente recebe a visita de enfermeiros, Internação Domiciliar: os pacientes mais estáveis podem contar com a internação domiciliar como uma opção."
    },
    {
      Icon: MoneyIcon,
      title: "Affordable",
